        ...
        MainLayout:
            ...
            EnermyScreen:
                ...
                Image:
                    ...
                    source: 'data/spider_walk1.png' if turnbutton.state == "down" else 'data/spider.png' if root.enermy.status == "ALIVE" else 'data/spider_dead.png'
                Label:
                    font_size: 20
                    text: 'Monster Name'
